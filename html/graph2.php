...
set terminal png large font arial 10 size 1100,{$GLOBALS['cfg']['graph_height']} nocrop enhanced xffffff x000000 xc0c0c0 xff0000

set title '$title' font 'arial,14'

plot '-' using 1:2 with $style linewidth 3 $point_type
EOT;
